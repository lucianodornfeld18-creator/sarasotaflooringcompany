...
/* HEADER */
.site-header{position:sticky;top:0;z-index:100;background:rgba(251,248,242,.96);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border-bottom:1px solid var(--gray-border)}
.nav-bar{display:flex;align-items:center;justify-content:space-between;padding:14px 22px;max-width:var(--container);margin:0 auto;gap:1rem}
.brand{display:flex;align-items:center;gap:11px;text-decoration:none;flex-shrink:0}
.brand img{height:44px;width:auto}
.brand-text{display:flex;flex-direction:column;line-height:1}
.brand-name{font-family:var(--font-head);font-weight:800;font-size:1.16rem;color:var(--emerald);letter-spacing:-.02em;white-space:nowrap}
.brand-tag{font-size:.68rem;letter-spacing:.16em;color:var(--caramel-dark);text-transform:uppercase;margin-top:3px;white-space:nowrap;font-weight:600}
.nav-menu{display:flex;align-items:center;gap:1.3rem;list-style:none;flex-wrap:nowrap;margin:0;padding:0}
.nav-menu li{position:relative;margin:0}
.nav-menu>li>a{font-family:var(--font-head);font-weight:500;color:var(--ink);font-size:.94rem;padding:8px 4px;white-space:nowrap}
.nav-menu>li>a:hover{color:var(--emerald)}
.dropdown{position:absolute;top:calc(100% + 6px);left:50%;transform:translateX(-50%) translateY(-8px);background:#fff;min-width:240px;border-radius:var(--radius);box-shadow:var(--shadow-lg);padding:.6rem 0;opacity:0;visibility:hidden;transition:all var(--transition);z-index:99;border:1px solid var(--gray-border);list-style:none;margin:0}
...
.nav-phone{display:flex;align-items:center;gap:6px;color:var(--emerald);font-family:var(--font-head);font-weight:600;font-size:.95rem;white-space:nowrap}
.nav-phone svg{width:16px;height:16px;flex-shrink:0}
.menu-toggle{display:none;background:none;border:none;cursor:pointer;padding:8px;color:var(--emerald)}
...
@media(max-width:880px){
  .nav-menu{display:none;position:absolute;top:100%;left:0;right:0;background:#fff;flex-direction:column;align-items:stretch;padding:1rem 0;box-shadow:var(--shadow-lg);border-bottom:1px solid var(--gray-border)}
  .nav-menu.open{display:flex}
  .nav-menu li{margin:0;width:100%}
  .nav-menu>li>a{padding:.85rem 1.5rem;display:block;border-bottom:1px solid var(--gray-border)}
  .dropdown{position:static;transform:none;opacity:1;visibility:visible;box-shadow:none;border:none;background:var(--cream);min-width:0;border-radius:0;padding:.4rem 0;display:none}
  ...
  .hero{min-height:78vh;min-height:560px;padding:80px 22px 70px}
...
# ============================================================================
LOGO_SVG = """<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-label="Sarasota Flooring Company"><defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#1F5F3F"/><stop offset="100%" stop-color="#163E29"/></linearGradient></defs><rect width="64" height="64" rx="12" fill="url(#g1)"/><path d="M14 18h36v3.6H14zm0 8.8h36v3.6H14zm0 8.8h36v3.6H14zm0 8.8h36v3.6H14z" fill="#C8893D" opacity=".95"/><path d="M14 18l36 28.8" stroke="#FBF8F2" stroke-width="1.4" stroke-linecap="round" opacity=".55"/></svg>"""
  ...
  <nav class="nav-bar" aria-label="Primary navigation">
    <a href="/" class="brand" aria-label="{BUSINESS['name']} — home">
      ...
      <span class="brand-text">
        <span class="brand-name">Sarasota Flooring Co.</span>
        <span class="brand-tag">Owner-Installed</span>
      </span>
    </a>
...
<a href="{WA_LINK}" target="_blank" rel="noopener" class="wa-float" aria-label="Chat with us on WhatsApp">
  <svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.5 14.4c-.3-.1-1.7-.8-2-.9-.3-.1-.5-.1-.7.1-.2.3-.7.9-.9 1.1-.2.2-.3.2-.6.1-.3-.1-1.2-.4-2.3-1.4-.9-.8-1.4-1.7-1.6-2-.2-.3 0-.4.1-.6.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2 0-.4 0-.5-.1-.1-.7-1.6-.9-2.2-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.5.1-.8.4-.3.3-1 1-1 2.4 0 1.4 1 2.8 1.2 3 .1.2 2 3.1 4.9 4.3.7.3 1.2.5 1.6.6.7.2 1.3.2 1.8.1.6-.1 1.7-.7 1.9-1.4.2-.7.2-1.2.2-1.4-.1-.1-.3-.2-.6-.3zM12 2a10 10 0 0 0-8.6 15l-1.4 5 5.1-1.3A10 10 0 1 0 12 2zm0 18.3c-1.6 0-3.2-.4-4.5-1.3l-.3-.2-3.3.9.9-3.2-.2-.3a8.3 8.3 0 1 1 7.4 4.1z"/></svg>
  Free Quote
</a>
<script>{JS}</script>"""
...
def wa_banner(message=None):
    msg = message or "Get a free in-home estimate within 24 hours"
    return f"""<div class="wa-banner">
  <div>
    <p class="wa-banner-head">{msg}</p>
    <p class="wa-banner-sub">Call, text, or WhatsApp the owner directly — 7 days a week</p>
  </div>
  <a href="{WA_LINK}" target="_blank" rel="noopener" class="btn">WhatsApp Now</a>
</div>"""
